...
public class Classify3CAC {
	...
	public static void initialClassification(boolean viralVerify, boolean flyeAssembly, String file_threeClass, ArrayList<Integer> contigs_plas, ArrayList<Double> score_plas, ArrayList<Integer> contigs_phage, ArrayList<Double> score_phage, ArrayList<Double> pvalue_phage, ArrayList<String> initial_class){
		try{
...
//		System.out.println("finish propagation steps !  ");
	...
	public static void main (String args[]){
		try{
			...
			initialClassification(viralVerify, flyeAssembly, file_threeClass, contigs_plas, score_plas, contigs_phage, score_phage, pvalue_phage, initialClass);
