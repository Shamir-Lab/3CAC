...
public class PhageAndPlasmidContigs {
	...
	public static void writePhagesAndPlasmids(String file_outdir, boolean viralVerify, String file_classification, ArrayList<Integer> contigs_ID, ArrayList<ArrayList<String>> contigs_Seq){
		try{
			BufferedWriter writer_phage = new BufferedWriter(new FileWriter(file_outdir+"phageContigs.fasta"));
			BufferedWriter writer_plasmid = new BufferedWriter(new FileWriter(file_outdir+"plasmidContigs.fasta"));
			...
			System.out.println(num_phage+" contigs predicted as phages by"+file_classification+" could be found in: "+file_outdir+"phageContigs.fasta");
			System.out.println(num_plasmid+" contigs predicted as plasmids by"+file_classification+" could be found in: "+file_outdir+"plasmidContigs.fasta");
	...
	public static void main (String args[]){
		try{
			...
			writePhagesAndPlasmids(file_outdir, viralVerify, file_classification, contigs_ID, contigs_Seq);
