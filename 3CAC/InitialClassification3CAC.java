...
public class InitialClassification3CAC {
	...
	public static void readViralVerify(String file_threeClass, ArrayList<Integer> contigs_plas, ArrayList<Double> score_plas, ArrayList<Integer> contigs_phage, ArrayList<Double> score_phage, ArrayList<Double> pvalue_phage, boolean flyeAssembly){
		try{
			BufferedWriter writer = new BufferedWriter(new FileWriter("3CAC_initial_classification.fasta"));
	...
	public static void readPPRMeta(String file_threeClass, ArrayList<Integer> contigs_plas, ArrayList<Double> score_plas, ArrayList<Integer> contigs_phage, ArrayList<Double> score_phage, ArrayList<Double> pvalue_phage, boolean flyeAssembly){
		try{
			BufferedWriter writer = new BufferedWriter(new FileWriter("3CAC_initial_classification.fasta"));
	...
	public static void main (String args[]){
		try{
			...
			if(viralVerify){
				readViralVerify(file_threeClass, contigs_plas, score_plas, contigs_phage, score_phage, pvalue_phage, flyeAssembly);
			}
			else{
				readPPRMeta(file_threeClass, contigs_plas, score_plas, contigs_phage, score_phage, pvalue_phage, flyeAssembly);
			}
			System.out.println("The initial classification of 3CAC can be found in: 3CAC_initial_classification.fasta");
