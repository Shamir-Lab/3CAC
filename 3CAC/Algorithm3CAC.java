...
//		System.out.println("finish propagation steps !  ");
    ...
    public static void finalContigCategoryFromEdges(ArrayList<Integer> contigs, ArrayList<ArrayList<Integer>> contigEdges, int[] edgesLength, int[] edgesCate, boolean flyeAssembly){
    	try{
    		BufferedWriter writer = new BufferedWriter(new FileWriter("3CAC_classification.fasta"));
    		...
    		writer.close();
    		System.out.println("The final classification of 3CAC can be found in: 3CAC_classification.fasta");
	...
	public static void main (String args[]){
		try{
			...
			finalContigCategoryFromEdges(contigs, contigEdges, edgesLength, edgesCate, flyeAssembly);
